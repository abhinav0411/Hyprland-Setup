...
class Animation(Scene):
    ...
    def affected_land(self, lands):
        lands[0].set_fill(RED, opacity=0.5)
        lands[1].set_fill(YELLOW, opacity=0.5)
        lands[4].set_fill(YELLOW, opacity=0.5)
        lands[3].set_fill(YELLOW, opacity=0.5)
    ...
    def construct(self):
        ...
        self.affected_land(nine_pieces)
