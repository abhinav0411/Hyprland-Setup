...
class Animation(Scene):
    ...
    def construct(self):
        ...
        nine_pieces[0].set_fill(RED, opacity=0.5)
        nine_pieces[1].set_fill(YELLOW, opacity=0.5)
        nine_pieces[4].set_fill(YELLOW, opacity=0.5)
        nine_pieces[3].set_fill(YELLOW, opacity=0.5)
