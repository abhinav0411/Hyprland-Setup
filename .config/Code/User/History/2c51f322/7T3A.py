...
class Animation(Scene):
    ...
    def construct(self):
        ...
        Dsa_explanation = Paragraph(
            "Each Plot depends on its neighbours. "
            "We can use this to check soil health.",
            alignment="center",
            line_spacing=0.8
        ).scale(0.6)
        Dsa_explanation.next_to(nine_pieces, UP)
        Dependency = Paragraph(
            "Soil of Plot 1 depends on "
            "the soils of Plot 2, 4 and 5",
            alignment="center",
            line_spacing=0.8
        ).scale(0.6)
        Dependency.next_to(nine_pieces,UP)
        Explanation_of_Project = Paragraph(
            "Farmers capture images of their plots, ",
            "and our app analyzes and compares them to check soil health",
            alignment="center",
            line_spacing=0.8
        ).scale(0.7)
        Explanation_of_Project.next_to(four_pieces, UP)
        ...
        self.play(Write(Explanation_of_Project))
        self.wait(2)
        self.play(FadeOut(Explanation_of_Project))
        ...
        self.wait(5)
        self.play(FadeOut(Dsa_explanation))

        self.play(
            nine_pieces[0].animate.set_fill(RED, opacity=0.5),
            nine_pieces[1].animate.set_fill(YELLOW, opacity=0.5),
            nine_pieces[4].animate.set_fill(YELLOW, opacity=0.5),
            nine_pieces[3].animate.set_fill(YELLOW, opacity=0.5),
        )
        self.play(Write(Dependency))
        self.wait(5)
